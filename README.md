...
The main release is [FoxTunes-9.3.2-net48.zip](https://github.com/pudding-fox/FoxTunes.Next/releases/download/9.3.2/FoxTunes-9.3.2-net48.zip).  
For additional plugins, download [FoxTunes-9.3.2-Plugins-net48.zip](https://github.com/pudding-fox/FoxTunes.Next/releases/download/9.3.2/FoxTunes-9.3.2-Plugins-net48.zip) (extract and copy required folders to the FoxTunes\lib directory).
