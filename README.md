...
The main release is [FoxTunes-7.0.5-net48.zip](https://github.com/pudding-fox/FoxTunes.Next/releases/download/7.0.5/FoxTunes-7.0.5-net48.zip).  
For additional plugins, download [FoxTunes-7.0.5-Plugins-net48.zip](https://github.com/pudding-fox/FoxTunes.Next/releases/download/7.0.5/FoxTunes-7.0.5-Plugins-net48.zip) (extract and copy required folders to the FoxTunes\lib directory).
