...
The main release is [FoxTunes-6.0.0-net48.zip](https://github.com/pudding-fox/FoxTunes.Next/releases/download/6.0.0/FoxTunes-6.0.0-net48.zip).  
For additional plugins, download [FoxTunes-6.0.0-Plugins-net48.zip](https://github.com/pudding-fox/FoxTunes.Next/releases/download/6.0.0/FoxTunes-6.0.0-Plugins-net48.zip) (extract and copy required folders to the FoxTunes\lib directory).
