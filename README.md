...
The main release is [FoxTunes-9.2.0-net48.zip](https://github.com/pudding-fox/FoxTunes.Next/releases/download/9.2.0/FoxTunes-9.2.0-net48.zip).  
For additional plugins, download [FoxTunes-9.2.0-Plugins-net48.zip](https://github.com/pudding-fox/FoxTunes.Next/releases/download/9.2.0/FoxTunes-9.2.0-Plugins-net48.zip) (extract and copy required folders to the FoxTunes\lib directory).
