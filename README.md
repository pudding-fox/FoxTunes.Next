...
The main release is [FoxTunes-7.0.4-net48.zip](https://github.com/pudding-fox/FoxTunes.Next/releases/download/7.0.4/FoxTunes-7.0.4-net48.zip).  
For additional plugins, download [FoxTunes-7.0.4-Plugins-net48.zip](https://github.com/pudding-fox/FoxTunes.Next/releases/download/7.0.4/FoxTunes-7.0.4-Plugins-net48.zip) (extract and copy required folders to the FoxTunes\lib directory).
