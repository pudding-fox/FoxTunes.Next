...
namespace FoxTunes
{
    ...
    public class DiscogsBackCoverMetaDataSource : StandardComponent, IOnDemandMetaDataSource
    {
        ...
        public string Name
        {
            get
            {
                return CommonImageTypes.BackCover;
            }
        }
        ...
        public async Task<OnDemandMetaDataValues> GetValues(IEnumerable<IFileData> fileDatas, OnDemandMetaDataRequest request)
        {
            ...
            return this.Behaviour.GetMetaDataValues(releaseLookups, CommonImageTypes.BackCover, true);
        }
    }
}
