...
namespace FoxTunes
{
    public static class FlacEncoderSettingsConfiguration
    {
        ...
        public const string DEPTH = "AAAA45EA-6B59-43F8-A578-5C1C3640978F";
        ...
        public const string COMPRESSION = "FFFF737A-B151-436D-8EAE-603A2202597A";

        public const string IGNORE_ERRORS = "GGGG821F-7A7B-4B3F-BE5D-F046AEFAAC6A";
        ...
        public static IEnumerable<ConfigurationSection> GetConfigurationSections(IBassEncoderSettings settings)
        {
            yield return new ConfigurationSection(SECTION)
                ...
                .WithElement(new IntegerConfigurationElement(COMPRESSION, "Compression Level", path: settings.Name)
                    ...
                    .DependsOn(SECTION, ENABLED))
                .WithElement(new BooleanConfigurationElement(IGNORE_ERRORS, "Ignore Errors", path: settings.Name)
                    .WithValue(true)
                    .DependsOn(SECTION, ENABLED)
            );
        }
