...
namespace FoxTunes
{
    public static class OscilloscopeConfiguration
    {
        ...
        public const string MODE = "AAAAD149-F777-46CB-92C0-F479CEE72A91";
        ...
        public const string WINDOW = "AABBF71F-72AD-46F6-964F-A4D30539C87E";
        ...
        public const string DURATION = "BBBBE8CC-88E9-4B66-B2FB-3577CD32D8C7";
        ...
        public static IEnumerable<ConfigurationSection> GetConfigurationSections()
        {
            yield return new ConfigurationSection(SECTION, Strings.OscilloscopeConfiguration_Section)
                .WithElement(new SelectionConfigurationElement(MODE, Strings.OscilloscopeConfiguration_Mode).WithOptions(GetModeOptions()))
                .WithElement(new IntegerConfigurationElement(WINDOW, Strings.OscilloscopeConfiguration_Window).WithValue(WINDOW_DEFAULT).WithValidationRule(new IntegerValidationRule(WINDOW_MIN, WINDOW_MAX, 10)))
                ...
                .WithElement(new IntegerConfigurationElement(DURATION, Strings.OscilloscopeConfiguration_Duration).WithValue(DURATION_DEFAULT).WithValidationRule(new IntegerValidationRule(DURATION_MIN, DURATION_MAX, 10)))
