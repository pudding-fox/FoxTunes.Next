...
{
    public partial class AddLibraryHierarchyNodesToPlaylist
    {
        public AddLibraryHierarchyNodesToPlaylist(IDatabase database, IFilterParserResult filter, ISortParserResult sort)
        {
