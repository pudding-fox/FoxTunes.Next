    ...
    public static class DiscordBehaviourConfiguration
    {
        ...
        public static IEnumerable<ConfigurationSection> GetConfigurationSections()
        {
            yield return new ConfigurationSection(SECTION, Strings.DiscordBehaviourConfiguration_Section)
                ...
                .WithElement(new TextConfigurationElement(STATE_SCRIPT, Strings.DiscordBehaviourConfiguration_StateScript, Strings.General_Advanced).WithValue(Resources.State))
                .WithElement(new TextConfigurationElement(DETAILS_SCRIPT, Strings.DiscordBehaviourConfiguration_DetailsScript, Strings.General_Advanced).WithValue(Resources.Details)
            );
        }
    }
}
